...
plt.fill_between(
    range(len(TRB)), trb - std_trb, trb + std_trb, color="green", alpha=0.1
)
plt.plot(tr, label="optim. topo tr", c="blue", linestyle="dashed")
plt.fill_between(range(len(TR)), tr - std_tr, tr + std_tr, color="blue", alpha=0.1)
...
plt.fill_between(
    range(len(TEB)), teb - std_teb, teb + std_teb, color="green", alpha=0.1
)
plt.plot(te, label="optim. topo te", c="blue")
plt.fill_between(range(len(TE)), te - std_te, te + std_te, color="blue", alpha=0.1)
